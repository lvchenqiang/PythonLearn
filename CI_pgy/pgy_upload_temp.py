...
#蒲公英提供的 用户Key
uKey = 'b5defd134a1d76d7118a05cbff0490ac'

#蒲公英提供的 API Key
_api_key = '77658f6912fd0f8243aa1a03c027ad21'
...
def _encode_multipart(params_dict):
    ...
    for k, v in params_dict.items():
        ...
        if hasattr(v, 'read'):
            ...
            data.append("Content-Disposition: form-data; name=\"%s\"; filename=\"ellabook.ipa\"" % k)
...
req = urllib3.Request(url, coded_params.encode('ISO-8859-1'))
